...
namespace Prism.Regions
{
    ...
    public partial class ViewsCollection : IViewsCollection
    {
        ...
        {
            var d = itemMetadata.MetadataChanged.Subscribe(args =>
            {
                OnItemMetadataChanged(args.Sender, args);
            });
            _disposables.Add(itemMetadata, d);
        ...
        {
            _disposables[itemMetadata].Dispose();
